//
// presets.cpp — CloudSeed preset arrays.
// Originally from DreamDexed (GPL-3.0, Akashic Trance Machines).
//
#ifndef BUFFER_SIZE
...
const float *const CSPresets[CS_NUM_PRESETS] =
{
    UInit,
    FXDivineInspiration, FXLawsOfPhysics, FXSlowBraaam, FXTheUpsideDown,
    LBigSoundStage, LDiffusionCyclone, LScreamIntoTheVoid,
    M90sDigitalReverb, MAiryAmbience, MDarkPlate, MGhostly, MTappedLines,
    SFastAttack, SSmallPlate, SSnappyAttack,
};
